    ...
    <div class="row m-0">
      ...
      <div class="col col-auto pr-0">
        <div class="btn-group" role="group" aria-label="code file controls">
          <a role="button" class="btn btn-secondary border-0 rounded-0" aria-label="download file" target="_blank" href="#{url}"><img class="btn-icon" src="/images/commons/icons/download.svg"></a>
