---
id: 1025
title: 'Writing OpenAPI (Swagger) Specification Tutorial - Part 5 - Advanced Input And Output Modeling'
date: 2016-05-06T20:26:57+00:00
author: Arnaud Lauret
layout: post
guid: http://apihandyman.io/?p=1025
...
## 1.1 Required or optional parameter
...
### 1.1.1 Defining a required or optional parameter
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="480-485" highlight="483" show_meta="1"]

When used in an operation, the `pageSize` parameter is NOT mandatory (`required` is not defined and therefore is false).
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="486-497" show_meta="1"]

### 1.1.2 Defining a required or optional property in a definition used as a parameter
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="297-322" highlight="298-299" show_meta="1"]

## 1.2 Parameter with default value
...
### 1.2.1 Defining a parameter's default value
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="486-497" highlight="497" show_meta="1"]
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="498-503" highlight="503" show_meta="1"]

### 1.2.2 Defining a property's default value in a definition used as a parameter
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="323-329" highlight="326-329" show_meta="1"]
...
## 1.3 Parameter with empty value
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="504-509" highlight="509" show_meta="1"]
...
### 1.4.1 Defining a separated values parameter
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="510-519" highlight="513,517,5195" show_meta="1"]
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="510-520" highlight="520" show_meta="1"]
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="510-523" highlight="521-523" show_meta="1"]

### 1.4.2 Defining a multiple values parameter
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="524-531" highlight="527,528,529,531" show_meta="1"]

And icing on the cake we enforce the possible values by defining an `enum` on the string within the array:
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="524-535" highlight="532-535" show_meta="1"]

## 1.5 Parameter location is not only path, query or body
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="536-540" show_meta="1"]

And we use it (on every path) just like any other parameter:
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="16-19" highlight="19" show_meta="0"]
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_16_advanced_input_and_output_modeling_form.txt" show_meta="1"]
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="77-104" highlight="80,81,86,93,96,99" show_meta="1"]
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="230-247" highlight="236,239,240" show_meta="1"]
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="10-12" show_meta="1"]

This settings can be overriden on the operation level by redefining the consumes list:
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="230-247" highlight="235-236" show_meta="1"]
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="43-55" highlight="54-55" show_meta="1"]

## 2.2 Required or optional values in response
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="297-322" highlight="298-298" show_meta="1"]

## 2.3 Response's headers
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="43-61" highlight="56-61" show_meta="1"]

Unfortunately there's *absolutely no way* of defining such headers once and for all (for now).

## 2.4 Default response
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="470-471" show_meta="1"]

This response used as a `default` response on each operation:
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="153-170" highlight="169" show_meta="1"]

Unfortunately there's *absolutely no way* of defining a global response once and for all (for now).

## 2.5 Response's media types
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="13-15" show_meta="1"]
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="258-294" highlight="268-273" show_meta="1"]
...
# 3 How to use a single definition when output returns more data than input needs
...
[gist id="5a3df2250721fb154060" file="simple_openapi_specification_15_advanced_input_and_output_modeling.yaml" lines="297-322" highlight="316" show_meta="1"]
